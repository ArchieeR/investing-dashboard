...
| UI Design System | `.claude/skills/ui_design_system/SKILL.md` | Design tokens, Electric Blue theme |
...
- **Golden Rule:** **Electric Blue Theme**.
    - Use `bg-slate-950` for backgrounds.
    - Use `text-slate-50` for primary text.
