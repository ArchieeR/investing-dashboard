...
// Ported from _portfolio-reference/src/state/selectors.ts
// =============================================================================
...
const calculateTargetHierarchy = (
  portfolio: Portfolio,
  ...
  // Legacy fallback: use current theme totals as targets
...
const liveCalculationCache = new Map<
  string,
  {
    liveTotals: LivePortfolioTotals;
...
const targetCalculationCache = new Map<
  string,
  {
